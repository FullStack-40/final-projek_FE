    ...
    <div>
      ...
      <div className="flex justify-between pt-24">
        ...
        <div className="pr-72">
          <h1 className=" text-3xl font-bold">
            Apa Kelebihan <br />{" "}
            <span className="text-green-600">LifeWell </span> ?
          </h1>
          <p className=" pt-8">
            Berikut adalah beberapa kelebihan yang kami <br /> tawarkan untuk
            membantu anda <br />
            dalam menangani masalah anda.
          </p>
        </div>
      </div>
      ...
      <div className=" pt-14 flex justify-between ">
        <div className=" bg-primary-color w-72 h-auto pl-6 pr-4 pt-7 pb-5 rounded-lg ml-40">
          ...
          <p className="text-white font-normal">
            Dokter yang berpengalaman pada masing-masing bidang dengan jam
            terbang tinggi dan kecakapan dalam membantu anda.
          </p>
        </div>
        ...
        <div className=" bg-primary-color w-72 h-auto pl-6 pr-4 pt-7 pb-5 rounded-lg">
          ...
          <p className="text-white font-normal">
            Layanan 24 Jam dengan cepat tanggap yang senantiasa membantu anda
        ...
        <div className=" bg-primary-color w-72 h-auto pl-6 pr-4 pt-7 pb-5 rounded-lg mr-32 ">
          ...
          <p className="text-white font-normal">
            Harga yang terjangkau yang dapat memudahkan anda dalam memesan jasa
            konsultasi.
          </p>
        </div>
      </div>
      ...
      <div className=" text-center pt-28">
        <div>
          <h1 className=" text-3xl font-bold pb-3">
            Dokter <span className=" text-green-600">Terbaik Kami</span>.
          </h1>
        </div>

        <div>
          <h5>
            Dokter-dokter kami adalah para ahli dalam beragam bidang kesehatan.{" "}
            <br /> Mereka memiliki pengalaman luas, pengetahuan mendalam, <br />
            dan komitmen untuk memberikan perawatan terbaik kepada Anda. <br />
            Kami mengerti bahwa setiap individu memiliki kebutuhan yang unik{" "}
            <br />
            dan inilah mengapa kami memiliki beragam spesialisasi.
          </h5>
        </div>
      </div>
      ...
      <div className="flex justify-between pt-28">
        ...
        <div className=" mr-52 pt-11">
          ...
          <p className=" mt-2">
            Dokter Agus Hermawan adalah seorang ahli gizi terkemuka <br />
      ...
      <div className="bg-primary-color mt-32 pt-24 pb-20 text-white flex">
        <div className=" ml-36">
          ...
          <p>
            Sebuah aplikasi website kesehatan
            <br /> yang menyediakan fasilitas berupa
            <br /> sesi konsultasi dengan dokter-dokter
            <br /> yang sudah berpengalaman dibidangnya,
            <br /> juga menyediakan artikel-artikel terkait <br />
            kesehatan.
          </p>
        </div>
        ...
        <div className=" ml-20">
          ...
          <p>
            Alamat : Jalan Lorem Ipsum <br /> No 10, Jakarta, <br />
            Indonesia
          </p>
        ...
        <div className="ml-20">
          ...
          <p>
            Dapatkan kabar <br />
            berita kami dengan <br /> cepat dan mudah.
          </p>
        </div>
      </div>
    </div>
